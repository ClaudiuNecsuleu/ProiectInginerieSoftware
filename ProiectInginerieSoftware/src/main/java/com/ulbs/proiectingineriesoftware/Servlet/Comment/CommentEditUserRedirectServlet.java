...
@WebServlet(name = "CommentEditUserRedirectServlet", urlPatterns = {"/CommentEditUserRedirectServlet"})
public class CommentEditUserRedirectServlet extends HttpServlet {
